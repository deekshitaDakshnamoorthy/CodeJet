...
export default function MainC() {
  ...
  return (
    <div style={{backgroundColor:'#E7CBCB'}}>
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{backgroundColor:'#643843'}}>
        <Toolbar>
    ...
    <Typography sx={{paddingBottom:'50px'}}>
        <h1 style={{textAlign:'left',fontFamily:'serif',fontSize:'50px',marginLeft:'70px'}}> TYPESCRIPT Tutorial:</h1>
        <div>
